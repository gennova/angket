	...
	<div class="container"><br><br><br>
	  <div class="header2">
		...
		?>
			...
			<tr>
				<td>Username<input name="username" type="text" id="username" value="<?php echo $username; ?>"/></td>
			</tr>
			<tr>
				<td><br/>Password<input name="password" type="text" id="password" value="<?php echo $password; ?>"/></td>
			</tr>
			
			<tr>
				<td><br/>Nama<input name="nama" type="text" id="nama" value="<?php echo $nama; ?>" readonly></td>
			</tr>	
