...
<body background="../../images/background.jpg">
	...
	<div class="container"><br><br><br>
	  <div class="header2">
		...
		<?php
			$id=$_GET['idcontent'];
			$sql="select * from soal where soal='$id'";
		...
		?>
			<table>
			<form method="post" action="updatesoal.php">
			<tr>
				<td>No<input name="no" type="text" id="no" value="<?php echo $no; ?>"/></td>
			</tr>
			
			<tr>
				<td><br/>Soal<input name="soal" type="text" id="soal" value="<?php echo $soal; ?>"/></td>
			</tr>
