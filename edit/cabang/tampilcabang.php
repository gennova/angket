	...
	<div class="container"><br><br><br>
	  <div class="header2">
		...
		<form method='post' action=''>
		  	<input type='text' name='search' placeholder='Pencarian berdasarkan nama cabang / kota cabang'><br>
		  	<div align='center'>
			...
			if (isset($_POST["search"])) {
				...
				$query="SELECT * from cabang where nama='$search' || kota='$search'";
				...
				if($result){
					...
					while($row=mysql_fetch_array($result)){
						...
						echo "<td>[<a href=\"delcabang.php?idcontent=".$row['nama']."\">Hapus</a>]</td>";
						echo "<td>[<a href=\"editcabang.php?idcontent=".$row['nama']."\">Edit</a>]</td>";
						echo "</tr>\r";
					}
			...
			?><br><br>
			<div align='center'>
				<a href='inputcabang.php'><input type='button' value='Tambah Cabang'/></a>
			</div>
		</div>
	</div>
